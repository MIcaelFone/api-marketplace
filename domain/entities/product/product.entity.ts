export class ProductEntity {
    ...
    static create(name:string,description:string,price:number,categoryId:number,stock:number,sku:string): ProductEntity {
    ...
    static restore(id:number,name:string,categoryId:number,description:string,price:number,stock:number,sku:string,createdAt:Date,updatedAt:Date): ProductEntity {
        return new ProductEntity(
            id,
            name,
            description,
